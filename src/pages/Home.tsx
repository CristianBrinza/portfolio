            ...
            <div className="home_hero">
                <svg xmlns="http://www.w3.org/2000/svg" width="217" height="217" viewBox="0 0 217 217" fill="none">
                    ...
                    <path
                        ...
                        stroke="white" strokeWidth="15.19"/>
                    <path
                        ...
                        stroke="white" strokeWidth="15.19"/>
                    <path d="M125.86 108.5C125.86 108.5 128.037 108.5 172.673 108.5" stroke="white"
                          strokeWidth="15.19"/>
                    <path d="M123.227 85.0935C123.227 85.0935 123.227 87.2706 123.227 131.907" stroke="white"
                          strokeWidth="15.19"/>
                </svg>
                <div>
