...
export default function NotFound() {
  ...
  return (
    <>
      ...
      <Page className="not_found_page" gap="20px" style={{height: pageHeight}}>
      <Icon type="info" size="80px" color="var(--theme_primary_color_darkest_gray"/>
        <h1>
        ...
        <div className="not_found_page_under">
          ...
          If there should be something here <a href="https://github.com/CristianBrinza/portfolio/issues/new?title=[cristianbrinza.com] 404 not found&amp;labels=polaris.shopify.com">let us know</a>.
        </div>
      </Page>
      <Footer/>
    </>
