      ...
      <Page minHeight="80vh">
        <div>
          ...
          <Parapraph style={{ marginBottom: '20px' }}>
            Welcome to the Certifications & Courses section! Explore my learning
            journey as I continuously expand my knowledge and skills through
            various certifications and courses. From design principles to
            technical expertise, each course reflects a commitment to growth and
            staying ahead in the ever-evolving world of technology and design.
            Dive in to see how each certification adds value to my professional
            path!
          </Parapraph>
