...
export default function PasswordGenerator() {
    ...
    const generatePassword = () => {
        ...
        if (excludeAmbiguous) {
            characterPool = characterPool.split('').filter(char => !ambiguousChars.includes(char)).join('');
        }
        ...
        const formattedPassword = generatedPassword.match(/.{1,4}/g)?.join('-') || generatedPassword;
