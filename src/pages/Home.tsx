...
export default function Home() {
  ...
  return (
      <>
        <div className={`${styles.home_hero_new} ${isSticky ? styles.sticky : ''}`}>
          <Navbar />
        ...
        <div className={`main page`}>
          ...
          <div className={styles.home_block}>
            <Title className={`reveal ${styles.home_block_title}`}>See my work</Title>
            <Parapraph className={`reveal ${styles.home_page_paraghaph}`}>
          ...
          <div className={styles.home_block}>
            <Title className={`reveal ${styles.home_block_title}`}>Top Projects</Title>
            <Parapraph className={`reveal ${styles.home_page_paraghaph}`}>
              Check out some of my favorite projects! They highlight my love for creating user-friendly and visually engaging web experiences.
            </Parapraph>

            <div className="reveal" id={styles.home_portfolio_blocks}>
              <ShowCards items={showCardItems} />
            </div>
          </div>

          <div className={styles.home_block}>
            <Title className={`reveal ${styles.home_block_title}`}>Meet my workplaces</Title>
            <Parapraph className={`reveal ${styles.home_page_paraghaph}`}>
