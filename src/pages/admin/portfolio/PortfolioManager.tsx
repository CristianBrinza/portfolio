...
const PortfolioManager: React.FC = () => {
  ...
  return (
    <AdminLayout menu_items={menu} breadcrumb={breadcrumbItems}>
      <Title className="certification_manager_page_title">
        Portfolio Manager
      </Title>
                        ...
                        <div key={index} className="item_card">
                          ...
                          <div className="item_info">
                            ...
                            <div className="item_actions">
                              <Button
                                onClick={() => openPopup(category, '', item)}
                              >
                                Edit
                              </Button>
                              <Button
                    ...
                    subcategory => (
                      <div key={subcategory} className="subcategory_block">
                        <div className="subcategory_header">
                          ...
                          <div className="category_header_btns">
                            <Button
                              onClick={() => openPopup(category, subcategory)}
                            >
                              Add Item
                            </Button>
                            <Button
                            ...
                            <div key={index} className="item_card">
                              ...
                              <div className="item_info">
                                ...
                                <div className="item_actions">
                                  <Button
                                    onClick={() =>
                                      openPopup(category, subcategory, item)
                                    }
                                  >
                                    Edit
                                  </Button>
                                  ...
                                  <Button
                                    onClick={() =>
                                      moveItemUp(category, subcategory, index)
                                    }
                                    disabled={index === 0}
                                  >
                                    ←
                                  ...
                                  <Button
                                    onClick={() =>
                                      moveItemDown(category, subcategory, index)
                                    }
                                    disabled={
                                      index ===
                                      getItemsArray(
