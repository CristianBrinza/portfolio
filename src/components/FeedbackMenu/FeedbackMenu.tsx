    ...
    <div className={styles.FeedbackMenu}>
      ...
      {isFeedbackPopupVisible && (
        ...
        >
          ...
          <Parapraph style={{ color: '#434e4eff' }}>
            <b>
              2. How would you rate the usability and navigation of the
              portfolio?
            </b>
          </Parapraph>
          <div className={styles.FeedbackMenu_stars}>
          ...
          <Parapraph style={{ color: '#434e4eff' }}>
            <b>
              3. How likely are you to consider working with me based on this
              portfolio?
            </b>
          </Parapraph>
          <div className={styles.FeedbackMenu_stars}>
      ...
      {showNotification2 && (
        <Notification type="success">Thank you for your feedback.</Notification>
      )}
